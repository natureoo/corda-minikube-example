...
cd /app
echo "$PWD"
java -jar corda.jar --config-file=${CONFIG_FILE} --initial-registration --base-dir /app --network-root-truststore ./certificates/network-truststore.jks --network-root-truststore-password trustpass
